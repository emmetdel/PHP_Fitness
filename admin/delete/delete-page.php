...
<div class="container-fluid">
  ...
  <div class="navbar-header">
    ...
    <a class="navbar-brand" href="#">Delete Page</a>
  </div>
...
<div class="container page">
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  	...
  	if ($_POST['sure'] == 'Yes') { // Delete the record.
  		...
  		// Make the query:
  		$q = "DELETE FROM pages WHERE page_id=$id LIMIT 1";
  		...
  		echo '<p>The page has NOT been deleted.</p>';
  	}

  } else { // Show the form.

  	// Retrieve the user's information:
  	$q = "SELECT page_name FROM pages WHERE page_id=$id";
  	$r = @mysqli_query ($dbc, $q);
  	...
  	if (mysqli_num_rows($r) == 1) { // Valid user ID, show the form.
  		...
  		echo "<h3>Page Type: $row[page_name]</h3> Are you sure you want to delete this page?";

  		// Create the form:
  		echo '<form action="delete-page.php" method="post">
